...
_0x0:
	...
	.DB  0x61,0x6B,0x61,0x74,0x69,0x0,0x4E,0x69
	.DB  0x6B,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
_main:
; .FSTART _main
; 0000 002D unsigned char ch, counter=0;
; 0000 002E 
...
_0x6:
; 0000 004A       {
; 0000 004B         ch = getchar();
	CALL _getchar
	MOV  R17,R30
; 0000 004C         lcd_putchar(ch);
	MOV  R26,R17
	RCALL _lcd_putchar
; 0000 004D         putchar(ch);
	MOV  R26,R17
	CALL _putchar
; 0000 004E         if(ch == 'C')
	CPI  R17,67
...
; 0000 0050             lcd_clear();
	RCALL _lcd_clear
; 0000 0051             putchar(0x0D); //CL
	CALL SUBOPT_0x0
; 0000 0052             putchar(0x0A); //RF
; 0000 0053         }
; 0000 0054         else if(ch == 'N')
	RJMP _0xA
_0x9:
	CPI  R17,78
	BRNE _0xB
; 0000 0055         {
; 0000 0056             putchar(0x0D);
	CALL SUBOPT_0x0
; 0000 0057             putchar(0x0A);
; 0000 0058             usart_send_string("Niki Nezakati");
	__POINTW2MN _0xC,0
	RCALL _usart_send_string
; 0000 0059             putchar(0x0D);
	CALL SUBOPT_0x0
; 0000 005A             putchar(0x0A);
; 0000 005B 
; 0000 005C         }
; 0000 005D         else if(ch == 'c')
	RJMP _0xD
_0xB:
	CPI  R17,99
	BRNE _0xE
; 0000 005E         {
; 0000 005F             for(counter =0; counter < 24; counter++)
	LDI  R16,LOW(0)
_0x10:
	CPI  R16,24
	BRSH _0x11
; 0000 0060             {
; 0000 0061                 putchar(0x0D);
	CALL SUBOPT_0x0
...
_0x11:
; 0000 0064         }
; 0000 0065         else if(ch == 'M')
	RJMP _0x12
_0xE:
	CPI  R17,77
	BRNE _0x13
; 0000 0066         {
; 0000 0067             putchar(0x0D);
	CALL SUBOPT_0x0
...
; 0000 006A             lcd_gotoxy(6,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 006B             lcd_puts("Niki");
	__POINTW2MN _0xC,14
	RCALL _lcd_puts
; 0000 006C             lcd_gotoxy(4,1);
	LDI  R30,LOW(4)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 006D             lcd_puts("Nezakati");
	__POINTW2MN _0xC,19
	RCALL _lcd_puts
; 0000 006E         }
; 0000 006F 
