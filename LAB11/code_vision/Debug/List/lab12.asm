...
_0x0:
	.DB  0x4E,0x69,0x6B,0x69,0x20,0x4E,0x65,0x7A
	.DB  0x61,0x6B,0x61,0x74,0x69,0x0,0x39,0x38
	.DB  0x35,0x32,0x32,0x30,0x39,0x34,0x0
_0x20C0060:
	.DB  0x1
_0x20C0000:
...
; 0000 0046 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	OUT  0x12,R30
; 0000 0047 
; 0000 0048 // Specify the current font for displaying text
; 0000 0049 glcd_init_data.font=font5x7;
	LDI  R30,LOW(_font5x7*2)
	LDI  R31,HIGH(_font5x7*2)
	ST   Y,R30
	STD  Y+1,R31
; 0000 004A // No function is used for reading
; 0000 004B // image data from external memory
; 0000 004C glcd_init_data.readxmem=NULL;
	LDI  R30,LOW(0)
	STD  Y+2,R30
	STD  Y+2+1,R30
; 0000 004D // No function is used for writing
; 0000 004E // image data to external memory
; 0000 004F glcd_init_data.writexmem=NULL;
	STD  Y+4,R30
	STD  Y+4+1,R30
; 0000 0050 
; 0000 0051 glcd_init(&glcd_init_data);
	MOVW R26,R28
	RCALL _glcd_init
; 0000 0052 
; 0000 0053 while (1)
...
; 0000 0056         glcd_clear();
	RCALL _glcd_clear
; 0000 0057         glcd_moveto(5,0);
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _glcd_moveto
; 0000 0058         glcd_outtext("Niki Nezakati");
	__POINTW2MN _0x6,0
	CALL _glcd_outtext
; 0000 0059         glcd_moveto(5,55);
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R26,LOW(55)
	CALL _glcd_moveto
; 0000 005A         glcd_outtext("98522094");
	__POINTW2MN _0x6,14
	CALL _glcd_outtext
...
; 0000 005E         glcd_line(30,54,98,54);
	LDI  R30,LOW(30)
	ST   -Y,R30
	LDI  R30,LOW(54)
	ST   -Y,R30
	...
	LDI  R26,LOW(54)
	CALL _glcd_line
; 0000 005F         glcd_line(98,54,98,32);
	LDI  R30,LOW(98)
	ST   -Y,R30
	LDI  R30,LOW(54)
	ST   -Y,R30
	LDI  R30,LOW(98)
	CALL SUBOPT_0x1
; 0000 0060         glcd_line(30,32,30,54);
	LDI  R30,LOW(30)
	ST   -Y,R30
	LDI  R30,LOW(32)
	ST   -Y,R30
	...
	LDI  R26,LOW(54)
	CALL _glcd_line
; 0000 0061         glcd_line(20,32,30,32);
	LDI  R30,LOW(20)
	ST   -Y,R30
	LDI  R30,LOW(32)
	ST   -Y,R30
	LDI  R30,LOW(30)
	CALL SUBOPT_0x1
; 0000 0062         glcd_line(98,32,108,32);
	LDI  R30,LOW(98)
	ST   -Y,R30
	LDI  R30,LOW(32)
	ST   -Y,R30
	LDI  R30,LOW(108)
	CALL SUBOPT_0x1
; 0000 0063         glcd_line(108,32,64,5);
	LDI  R30,LOW(108)
	ST   -Y,R30
	LDI  R30,LOW(32)
	ST   -Y,R30
	LDI  R30,LOW(64)
	CALL SUBOPT_0x2
; 0000 0064         glcd_line(64,5,40,20);
	LDI  R30,LOW(64)
	ST   -Y,R30
	LDI  R30,LOW(5)
	ST   -Y,R30
	...
	LDI  R26,LOW(20)
	CALL _glcd_line
; 0000 0065         glcd_line(40,20,40,10);
	LDI  R30,LOW(40)
	ST   -Y,R30
	LDI  R30,LOW(20)
	ST   -Y,R30
	LDI  R30,LOW(40)
	CALL SUBOPT_0x3
; 0000 0066         glcd_line(40,10,45,10);
	LDI  R30,LOW(40)
	ST   -Y,R30
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R30,LOW(45)
	CALL SUBOPT_0x3
; 0000 0067         glcd_line(45,10,45,5);
	LDI  R30,LOW(45)
	ST   -Y,R30
	LDI  R30,LOW(10)
	ST   -Y,R30
...
; 0000 0068         glcd_line(45,5,25,5);
	...
	LDI  R30,LOW(25)
	CALL SUBOPT_0x2
; 0000 0069         glcd_line(25,5,25,10);
	LDI  R30,LOW(25)
	ST   -Y,R30
	LDI  R30,LOW(5)
	ST   -Y,R30
	LDI  R30,LOW(25)
	CALL SUBOPT_0x3
; 0000 006A         glcd_line(25,10,30,10);
	LDI  R30,LOW(25)
	ST   -Y,R30
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R30,LOW(30)
	CALL SUBOPT_0x3
; 0000 006B         glcd_line(30,10,30,25);
	LDI  R30,LOW(30)
	ST   -Y,R30
	LDI  R30,LOW(10)
	ST   -Y,R30
	...
	LDI  R26,LOW(25)
	CALL _glcd_line
; 0000 006C         glcd_line(30,25,20,32);
	LDI  R30,LOW(30)
	ST   -Y,R30
	LDI  R30,LOW(25)
	ST   -Y,R30
	LDI  R30,LOW(20)
	CALL SUBOPT_0x1
; 0000 006D         delay_ms(2000);
	CALL SUBOPT_0x0
; 0000 006E 
; 0000 006F         glcd_clear();
; 0000 0070         for(counter = 0; counter < 30; counter++)
	CLR  R4
	CLR  R5
_0x8:
	CALL SUBOPT_0x4
...
; 0000 0072           glcd_clear();
	CALL SUBOPT_0x5
; 0000 0073           glcd_circle(2 + 2 * counter, 60 - 2 * counter, 2);
	SUBI R30,-LOW(2)
	ST   -Y,R30
	CALL SUBOPT_0x6
; 0000 0074           delay_ms(70);
; 0000 0075         }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
_0x9:
; 0000 0076 
; 0000 0077         for(counter = 0; counter <= 31; counter++)
	CLR  R4
	CLR  R5
_0xB:
	LDI  R30,LOW(31)
...
; 0000 0079           glcd_clear();
	CALL SUBOPT_0x5
; 0000 007A           glcd_circle(60 + 2 * counter, 2 + 2 * counter, 2);
	SUBI R30,-LOW(60)
	ST   -Y,R30
	CALL SUBOPT_0x7
; 0000 007B           delay_ms(70);
; 0000 007C         }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
_0xC:
; 0000 007D 
; 0000 007E         for(counter = 0; counter < 30; counter++)
	CLR  R4
	CLR  R5
_0xE:
	CALL SUBOPT_0x4
	BRGE _0xF
; 0000 007F         {
; 0000 0080           glcd_clear();
	CALL SUBOPT_0x5
; 0000 0081           glcd_circle(118 - 2 * counter, 60 - 2 * counter, 2);
	LDI  R26,LOW(118)
	SUB  R26,R30
	ST   -Y,R26
	CALL SUBOPT_0x6
; 0000 0082           delay_ms(70);
; 0000 0083         }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
...
_0xF:
; 0000 0084 
; 0000 0085         for(counter = 0; counter < 30; counter++)
	CLR  R4
	CLR  R5
_0x11:
	CALL SUBOPT_0x4
...
; 0000 0087           glcd_clear();
	CALL SUBOPT_0x5
; 0000 0088           glcd_circle(60 - 2 * counter, 2 + 2 * counter, 2);
	LDI  R26,LOW(60)
	SUB  R26,R30
	ST   -Y,R26
	CALL SUBOPT_0x7
; 0000 0089           delay_ms(70);
; 0000 008A         }
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
